...
**기능:** 지정한 창고 슬롯에 있는 아이템의 상세 정보를 조회합니다.
...
**기능:** 창고에서 사용 중인 아이템 슬롯 또는 아이템 수를 조회합니다. 정확한 집계 기준은 게임에서 확인해야 합니다.
...
**기능:** 지정한 창고 슬롯에 있는 아이템의 중첩 수량을 조회합니다.
...
**기능:** 지정한 창고 아이템을 가방의 첫 빈 슬롯으로 이동합니다.
...
**기능:** 창고 슬롯, 아이템 이동과 보관 정보를 다룹니다. 작업을 확인하거나 요청합니다. 함수 이름과 매개변수 시그니처는 원본 덤프에서 확인됐지만 세부 동작 명세는 제공되지 않았습니다.
...
**기능:** Banker Npc 여부를 확인합니다. 조건 충족 여부를 확인하는 판정 계열 함수입니다. 이름상 참/거짓 값을 반환하는 것으로 추정됩니다.
...
**기능:** 창고 슬롯, 아이템 이동과 보관 정보를 다룹니다. 범위나 용량을 확장합니다. 함수 이름과 매개변수 시그니처는 원본 덤프에서 확인됐지만 세부 동작 명세는 제공되지 않았습니다.
...
- `aaPointStr` — `string` 추정: aaPointStr에 해당하는 문자열입니다. 허용 형식은 원본 덤프에 기록되어 있지 않습니다.
